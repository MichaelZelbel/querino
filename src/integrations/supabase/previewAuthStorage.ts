...
export function brokeredPreviewStorage() {
  ...
  const request = (
    ...
    new Promise((resolve) => {
      ...
      let done = false;
      // Assigned at the bottom of this block, after finish() exists, because finish()
      // closes over it to clear it. There is nothing to initialise it with up here, so
      // const would not compile. prefer-const cannot see that and has to be told.
