...
export function CopyToTeamModal({ open, onOpenChange, prompt }: CopyToTeamModalProps) {
  ...
  const handleCopy = async () => {
    ...
    const result = await copyPromptToTeam(
      prompt,
      selectedTeamId,
      selectedTeam.name,
      user.id,
  ...
  const handleOpenInTeam = () => {
    ...
    navigate(`/prompts/${copiedResult.slug}`);
    onOpenChange(false);
      ...
      <Dialog open={open} onOpenChange={handleClose}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Your prompt has been copied to <strong>{copiedResult.teamName}</strong>.
            </DialogDescription>
          </DialogHeader>
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a copy of "{prompt.title}" in a team workspace.
          </DialogDescription>
        </DialogHeader>
