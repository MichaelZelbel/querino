...
export function TranslateModal({
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      if (error)
        throw new Error(
          await getFunctionErrorMessage(error, "Failed to translate"),
        );
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <p className="text-sm text-muted-foreground">
            Translate this {artifactType} into another language. A new prefilled
            "{artifactType}" will be created with the translated content.
          </p>
