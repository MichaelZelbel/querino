...
export default function Auth() {
  ...
  useEffect(() => {
    const checkCap = async () => {
      try {
        ...
        ).supabase.rpc("check_signup_allowed");
  ...
  const redirectLabel = redirectTarget
    ? getRedirectLabel(redirectTarget)
    : null;
                    ...
                    <div className="flex flex-col items-center text-center py-6 space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground max-w-sm">
                          We've reached our early access limit. Join the
                          waitlist to be notified when new spots open up.
                        </p>
                      </div>
                    ...
                    <div className="flex flex-col items-center text-center py-6 space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground max-w-sm">
                          ...
                          . Click the link in that email to activate your
                          account.
                        </p>
                      </div>
