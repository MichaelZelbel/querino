              ...
              <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
                ...
                <section id="withdrawal">
                  ...
                  <p className="font-medium text-foreground">
                    Information on the Right of Withdrawal for Consumers in the
                    European Union
                  </p>
                  ...
                  <p className="mt-2">
                    ...
                    (Zelbel Ltd., 69 Great Hampton Street, Birmingham, B18 6EW,
                    United Kingdom, Email: support@querino.ai) of your decision
                    to withdraw from this contract by an unequivocal statement
                    (e.g., a letter sent by post or email). You may use the
                  ...
                  <p className="mt-2">
                    ...
                    communicated to us your withdrawal from this contract, in
                  ...
                  <ul className="list-disc pl-6 space-y-2 mt-2">
                    <li>
                      Contracts for the supply of digital content which is not
                      supplied on a tangible medium if the performance has begun
                      with your prior express consent and your acknowledgment
                      that you thereby lose your right of withdrawal.
                    </li>
                    <li>
                      Contracts for the supply of services if the service has
                      been fully performed by us and the performance has begun
                      with your prior express consent and your acknowledgment
                      that you would lose your right of withdrawal once the
                      contract had been fully performed by us.
                    </li>
                  </ul>
                  ...
                  <div className="mt-2 p-4 bg-muted/30 rounded-lg border border-border">
                    <p>
                      To: Zelbel Ltd., 69 Great Hampton Street, Birmingham, B18
                      6EW, United Kingdom
                    </p>
