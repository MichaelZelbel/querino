        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl space-y-20">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        and explore what the community has published. You can
                        filter by type, category, or just search for a topic.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Sign up with your email to unlock saving, creating, and
                        rating artifacts. It only takes a moment.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Use the <strong>"+ Create"</strong> button in the header
                        to write a prompt, prompt kit, skill, or workflow. Not
                        sure what to write? Try the{" "}
                        <Link
                          to="/prompts/wizard"
                          className="text-primary hover:underline"
                        >
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        shows everything you've created. Pin your favorites,
                        organize with collections, and iterate over time.
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground mb-4">
                Click <strong>"+ Create" → "Prompt"</strong> in the header. The
                editor gives you a comfortable writing area with line numbers.
                Fill in:
              </p>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  Be specific about the output format (e.g. "return a JSON
                  object with…")
                </li>
                <li>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground mb-4">
                Kits use a rich Markdown editor with a familiar toolbar
                (headings, lists, links, code, quotes, …). Between your prose,
                you insert dedicated <strong>prompt blocks</strong>. On the
                storage side this is a single Markdown document where each
                prompt is introduced by a <code>## Prompt: &lt;title&gt;</code>{" "}
              ...
              <ol className="space-y-3 text-muted-foreground">
                <li>
                  Click <strong>"+ Create" → "Prompt Kit"</strong> in the
                  header.
                </li>
                <li>
                  Write an intro that explains what the kit is for and how to
                  use it.
                </li>
                <li>
                  Click <strong>"Insert prompt"</strong> in the toolbar to add a
                  prompt block, give it a title, and write the prompt body.
                </li>
                <li>
                  Repeat for as many prompts as you need, with explanatory text
                  in between.
                </li>
                <li>
              ...
              <Tip>
                Markdown shortcuts work in the editor: type <code>#</code> +
                space for H1, <code>##</code> for H2, <code>-</code> for a list,{" "}
                <code>&gt;</code> for a quote, and so on.
              </Tip>
              ...
              <h3 className="text-lg font-semibold mt-8 mb-4">
                When to use a kit instead of a prompt
              </h3>
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  You have <strong>multiple prompts</strong> that only make
                  sense together.
                </li>
                <li>
                  You want to share <strong>guidance and context</strong>{" "}
                  alongside the prompts themselves.
                </li>
                <li>
                  You're publishing a{" "}
                  <strong>playbook, workshop, or template pack</strong> rather
                  than a single instruction.
                </li>
              </ul>

              <p className="text-muted-foreground mt-4">
                Kits support all the same actions as prompts: versioning,
                ratings and reviews, comments, suggestions, cloning, AI Coach
                and Insights, translation, Markdown import/export, GitHub Sync,
                Menerio sync, and team sharing.
              </p>
            </div>
          </section>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground mb-4">
                A <strong>prompt</strong> is a specific instruction for a single
                task ("Write me a blog post about…"). A <strong>skill</strong>{" "}
                is a broader definition of how the AI should behave across many
                tasks. You might use a "Technical Writer" skill as the system
                prompt, and then send individual prompts within that
                conversation.
              </p>

              <Tip>
                Skills support Markdown formatting, so you can structure them
                with headings, bullet points, and code blocks for clarity.
              </Tip>
              ...
              <div className="grid gap-3">
                <div className="p-4 rounded-lg border border-border bg-card">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Instructs the AI to write clear, concise documentation.
                    Defines tone, formatting rules, and audience expectations.
                  </p>
                </div>
                <div className="p-4 rounded-lg border border-border bg-card">
                  <p className="font-medium mb-1">Code Reviewer</p>
                  <p className="text-sm text-muted-foreground">
                    A structured framework for analyzing code: security checks,
                    performance, readability, and actionable improvement
                    suggestions.
                  </p>
                </div>
                <div className="p-4 rounded-lg border border-border bg-card">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Sets the AI's personality to be warm, empathetic, and
                    solution-oriented when handling customer queries.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <div className="grid gap-3">
                <div className="p-4 rounded-lg border border-border bg-card">
                  ...
                  <p className="text-sm text-muted-foreground">
                    1. Research topic → 2. Generate outline → 3. Write draft →
                    4. Review & edit → 5. Format for publication
                  </p>
                </div>
                <div className="p-4 rounded-lg border border-border bg-card">
                  <p className="font-medium mb-1">Bug Report Triage</p>
                  <p className="text-sm text-muted-foreground">
                    Reproduce → Classify severity → Identify root cause → Write
                    fix plan → Assign
                  </p>
                </div>
              </div>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ol className="space-y-3 text-muted-foreground">
                ...
                <li>
                  Give it a name and description (e.g. "Marketing prompts" or
                  "Onboarding kit for new devs").
                </li>
                <li>
                  Add artifacts from your library or from public content. You
                  can mix all artifact types.
                </li>
                <li>
                  Optionally make the collection public so others can discover
                  your curated set.
                </li>
              </ol>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ol className="space-y-3 text-muted-foreground">
                <li>
                  Click the <strong>workspace picker</strong> in the header (it
                  shows "Personal" by default).
                </li>
                <li>
              ...
              <p className="text-muted-foreground">
                Use the workspace picker in the header to switch between your
                personal library and any team workspace. Anything you create
                belongs to the workspace you currently have selected.
              </p>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              <p className="text-muted-foreground text-lg mb-6">
                Querino includes a suite of AI tools to help you create better
                artifacts faster. These features use AI credits from your
                account.
              </p>
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Available on every edit form. Click "Suggest with AI" and
                      Querino reads your content, then proposes a title,
                      description, category, and tags. You can accept, modify,
                      or discard each suggestion.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Get interactive feedback on the quality of your prompts,
                      skills, or workflows. The Coach analyzes structure,
                      clarity, and completeness, then offers specific tips for
                      improvement.
                    </p>
                  </CardContent>
                </Card>
              ...
              <Tip>
                AI features consume credits. You can see your remaining credits
                in{" "}
                <Link to="/settings" className="text-primary hover:underline">
                  Settings
                </Link>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              <p className="text-muted-foreground text-lg mb-6">
                Every time you save changes to an artifact, Querino keeps a
                snapshot of the previous version. This means you can always look
                back, compare, and even restore an older version if needed.
              </p>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  ...
                  <strong>"Version History"</strong> in the sidebar.
                </li>
                <li>
                  You'll see a timeline of all saved versions, each with a
                  timestamp and optional change notes.
                </li>
                <li>Click on any version to see its full content.</li>
                <li>
                  Use the <strong>compare view</strong> to see a side-by-side
                  diff between two versions.
                </li>
              </ul>

              <Tip>
                When saving, you can add a short <strong>change note</strong>{" "}
                (e.g. "Added error handling section") to make it easier to
                understand what changed later.
              </Tip>
            </div>
          </section>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground mb-4">
                On any artifact detail page, click the <strong>Download</strong>{" "}
                button. The exported file includes YAML frontmatter (title,
                description, tags, category, language) followed by the full
                content.
              </p>
              ...
              <p className="text-muted-foreground mb-4">
                ...
                <strong>"Import from Markdown"</strong> and select a{" "}
                <code>.md</code> file. Querino reads the frontmatter to pre-fill
                metadata and loads the content into the editor.
              </p>

              <h3 className="text-lg font-semibold mt-8 mb-4">GitHub Sync</h3>
              <p className="text-muted-foreground mb-4">
                Need automated backups instead of one-off downloads? Querino can
                push your entire library to a GitHub repository as Markdown
                files. See the dedicated{" "}
                <a href="#github-sync" className="text-primary hover:underline">
                  GitHub Sync
                </a>{" "}
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              <p className="text-muted-foreground text-lg mb-6">
                GitHub Sync mirrors your Querino artifacts to a GitHub
                repository as Markdown files. Use it for off-site backups,
                version control in Git, parallel editing in your IDE, or to feed
                your prompts into other tooling.
              </p>
              ...
              <p className="text-muted-foreground mb-4">
                Whenever you save or delete an artifact, Querino writes a small
                entry to an internal queue. A background worker runs every ~30
              ...
              <ol className="list-decimal pl-6 space-y-3 text-muted-foreground mb-4">
                <li>
                  <strong>Create a Personal Access Token (Classic)</strong> on
                  GitHub at{" "}
                  <a
                ...
                <li>
                  ...
                  public or private. Make sure the branch you want to push to
                  already exists.
                </li>
                <li>
                  Open{" "}
                  <Link to="/settings" className="text-primary hover:underline">
                    Settings → Integrations → GitHub Sync
                  </Link>{" "}
                  and paste your token.
                </li>
                <li>
                  Fill in the <strong>repository</strong> in{" "}
                  <code>owner/name</code> format (e.g.{" "}
                  <code>jane-doe/my-prompts</code>), the <strong>branch</strong>{" "}
                  (default <code>main</code>), and an optional{" "}
                  <strong>folder path</strong> like <code>querino</code> if you
                  want everything nested under a subfolder.
                </li>
                <li>
                  Click <strong>Test Connection</strong>. If it turns green,
                  click <strong>Enable GitHub Sync</strong> and then{" "}
                  <strong>Save GitHub Settings</strong>.
                </li>
              </ol>
              ...
              <p className="text-muted-foreground mb-4">
                Inside the folder you configured, Querino creates one subfolder
                per artifact type:
              </p>
    ...
    └── content-pipeline.md`}</code>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground mb-4">
                Every public artifact has a comment section. Ask questions,
                share how you've used a prompt, or give feedback. Comments
                support threaded replies, so conversations stay organized.
              </p>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  <strong>Endpoint:</strong> <code>https://mcp.querino.ai</code>
                </li>
                <li>
                  <strong>Transport:</strong> MCP Streamable HTTP (JSON-RPC 2.0
                  over POST; SSE responses supported)
                </li>
                <li>
                  <strong>Auth:</strong>{" "}
              ...
              <p className="text-muted-foreground mb-4">
                ...
                <strong>Querino MCP token</strong> (prefix <code>qrn_mcp_</code>
                ). Generate one in{" "}
                <Link to="/settings" className="text-primary hover:underline">
                  Settings → MCP Tokens
                </Link>
              ...
              <Tip>
                Treat MCP tokens like passwords. You can have several tokens at
                once (one per device or assistant) and revoke any of them
                individually.
              </Tip>
              ...
              <p className="text-muted-foreground mb-4">
                Once connected, your assistant gets a full toolset to manage
                your library:
              </p>
              <ul className="space-y-2 text-muted-foreground">
                <li>
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ol className="space-y-3 text-muted-foreground">
                <li>
                  In Menerio, go to <strong>Settings → Connections</strong> and
                  generate a <strong>Connection Key</strong> for Querino.
                </li>
                <li>
                  In Querino, open{" "}
                  <Link to="/settings" className="text-primary hover:underline">
                  ...
                  and find the <strong>Menerio</strong> section.
                </li>
                <li>
                  Paste the Connection Key and click <strong>"Connect."</strong>
                </li>
                <li>
                  If everything checks out, you'll see a green{" "}
                  <strong>"Connected"</strong> badge with your Menerio display
                  name.
                </li>
              </ol>
              ...
              <p className="text-muted-foreground mb-2">
                Once connected, you have three ways to sync:
              </p>
              <ul className="space-y-3 text-muted-foreground">
                <li>
              ...
              <p className="text-muted-foreground mb-4">
                ...
                <strong>cloud icon</strong> next to their title. You can also
                filter by sync status to quickly see which artifacts are synced
                and which aren't.
              </p>
              ...
              <Tip>
                You can choose which artifact types to sync (Prompts, Prompt
                Kits, Skills, Workflows) in the Menerio settings. This is useful
                if you only want certain types to appear in your Menerio
                knowledge base.
              </Tip>
            </div>
          </section>
              ...
              <div className="space-y-6">
                <Card>
                  ...
                  <CardContent className="text-sm text-muted-foreground space-y-2">
                    <p>
                      1. Create prompts as you use them in your daily AI work.
                    </p>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-base">
                      Standardizing AI usage in a team
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="text-sm text-muted-foreground space-y-2">
                    <p>
                      1. Create a team workspace and invite your colleagues.
                    </p>
                    <p>
                      2. Build a shared library of approved prompts and skills.
                    </p>
                    <p>
                      3. Use skills as system prompts so everyone gets
                      consistent AI behavior.
                    </p>
                    <p>
                      4. Document processes as workflows so new team members can
                      follow them.
                    </p>
                    <p>
                      5. Use reviews and comments to iterate on quality
                      together.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-base">
                      Creating a polished public prompt
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="text-sm text-muted-foreground space-y-2">
                    <p>
                      1. Start with the Kickstart Template to generate a first
                      draft.
                    </p>
                    <p>2. Edit and refine the content in the editor.</p>
                    <p>
                      3. Use the AI Coach to get feedback on clarity and
                      completeness.
                    </p>
                    <p>
                      4. Run AI Insights for a quality score and improvement
                      tips.
                    </p>
                    <p>
                      5. Toggle to public and share the link with the community.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-base">
                      Syncing your knowledge to Menerio
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="text-sm text-muted-foreground space-y-2">
                    <p>
                      1. Connect Menerio in Settings using your Connection Key.
                    </p>
                    <p>
                      2. Use "Sync all" to push your entire library at once.
                    </p>
                    <p>
                      3. Enable Auto-Sync so future changes flow automatically.
                    </p>
                    <p>
                      4. Your prompts and skills are now searchable in Menerio
          ...
          <section className="scroll-mt-24">
            ...
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              <p className="text-muted-foreground text-lg mb-6">
                ...
                page is where you manage your profile, integrations, and account
                preferences.
              </p>
