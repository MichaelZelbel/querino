...
import { d as composeEventHandlers$1, f as composeEventHandlers$2, u as composeEventHandlers } from "../radix-ui__primitive.mjs";
import { a as useComposedRefs, i as useComposedRefs$1 } from "../radix-ui__react-compose-refs.mjs";
import { c as createContextScope, s as createContextScope$1 } from "../radix-ui__react-context.mjs";
import { r as useSize } from "./react-checkbox+[...].mjs";
import { a as createCollection, c as createCollection$1, l as useComposedRefs$3, o as useComposedRefs$2, s as createContextScope$2, u as createContextScope$3 } from "./react-collection+[...].mjs";
import { t as useDirection } from "../radix-ui__react-direction.mjs";
import { d as useCallbackRef$2, f as Primitive$3, p as dispatchDiscreteCustomEvent$3, u as DismissableLayer } from "./react-dismissable-layer+[...].mjs";
...
__name$15(dispatchDiscreteCustomEvent$2, "dispatchDiscreteCustomEvent");
//#endregion
...
__name$14(useCallbackRef$1, "useCallbackRef");
//#endregion
...
var Popper = /* @__PURE__ */ __name$13((props) => {
...
var PopperAnchor = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$13(function PopperAnchor2(props, forwardedRef) {
...
var PopperContent = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$13(function PopperContent2(props, forwardedRef) {
	...
	const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
		...
		whileElementsMounted: /* @__PURE__ */ __name$13((...args) => {
		...
		middleware: [
			...
			size({
				...detectOverflowOptions,
				apply: /* @__PURE__ */ __name$13(({ elements, rects, availableWidth, availableHeight }) => {
...
__name$13(isNotNull, "isNotNull");
var transformOrigin = /* @__PURE__ */ __name$13((options) => ({
...
__name$13(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root2$1 = Popper;
...
//#endregion
//#region node_modules/@radix-ui/react-dropdown-menu/node_modules/@radix-ui/react-use-effect-event/dist/index.mjs
var __defProp$12 = Object.defineProperty;
var __name$12 = (target, value) => __defProp$12(target, "name", {
	value,
	configurable: true
});
var useReactEffectEvent$1 = import_react[" useEffectEvent ".trim().toString()];
var useReactInsertionEffect$1 = import_react[" useInsertionEffect ".trim().toString()];
function useEffectEvent$1(callback) {
	if (typeof useReactEffectEvent$1 === "function") return useReactEffectEvent$1(callback);
	const ref = import_react.useRef(() => {
		throw new Error("Cannot call an event handler while rendering.");
	});
	if (typeof useReactInsertionEffect$1 === "function") useReactInsertionEffect$1(() => {
...
var useInsertionEffect$1 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$2;
function useControllableState$1({ prop, defaultProp, onChange = /* @__PURE__ */ __name$11(() => {}, "onChange"), caller }) {
...
__name$11(useUncontrolledState$1, "useUncontrolledState");
function isFunction$1(value) {
	return typeof value === "function";
}
__name$11(isFunction$1, "isFunction");
var SYNC_STATE$1 = Symbol("RADIX:SYNC_STATE");
function useControllableStateReducer$1(reducer, userArgs, initialArg, init) {
	...
	const [internalState, dispatch] = import_react.useReducer((state2, action) => {
		if (action.type === SYNC_STATE$1) return {
			...state2,
			state: action.state
		};
...
__name$11(useControllableStateReducer$1, "useControllableStateReducer");
//#endregion
...
__name$10(dispatchDiscreteCustomEvent$1, "dispatchDiscreteCustomEvent");
//#endregion
...
var Portal$1 = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$9(function Portal2(props, forwardedRef) {
	...
	return container ? import_react_dom.createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$3.div, {
		...portalProps,
		ref: forwardedRef
	}), container) : null;
}, "Portal"));
...
//#endregion
//#region node_modules/@radix-ui/react-roving-focus/node_modules/@radix-ui/react-use-callback-ref/dist/index.mjs
...
//#endregion
//#region node_modules/@radix-ui/react-roving-focus/node_modules/@radix-ui/react-use-effect-event/dist/index.mjs
...
var [createRovingFocusGroupContext, createRovingFocusGroupScope] = createContextScope$2(GROUP_NAME, [createCollectionScope$1]);
...
var MENU_NAME = "Menu";
var [Collection, useCollection, createCollectionScope] = createCollection$1(MENU_NAME);
...
var MenuItem = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$1(function MenuItem2(props, forwardedRef) {
	...
	const handleSelect = /* @__PURE__ */ __name$1(() => {
		...
		if (!disabled && menuItem) {
			...
			dispatchDiscreteCustomEvent$3(menuItem, itemSelectEvent);
...
var MenuItemIndicator = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$1(function MenuItemIndicator2(props, forwardedRef) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$3.span, {
			...itemIndicatorProps,
			ref: forwardedRef,
...
var MenuSubTrigger = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$1(function MenuSubTrigger2(props, forwardedRef) {
	...
	const composedRefs = useComposedRefs$3(forwardedRef, subContext.onTriggerChange);
...
var DropdownMenuTrigger = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name(function DropdownMenuTrigger2(props, forwardedRef) {
	...
	const menuScope = useMenuScope(__scopeDropdownMenu);
	const composedRefs = useComposedRefs$1(forwardedRef, context.triggerRef);
...
var DropdownMenuContent = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name(function DropdownMenuContent2(props, forwardedRef) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2$1, {
		...
		onInteractOutside: composeEventHandlers$2(props.onInteractOutside, (event) => {
