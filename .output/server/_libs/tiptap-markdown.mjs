...
import { t as require_markdown_it_task_lists } from "./markdown-it-task-lists.mjs";
...
addStorage() {
	...
	HTMLMark,
	Mark.create({ name: "italic" }).extend({ 
	/**
	* @return {{markdown: MarkdownMarkSpec}}
	*/
addStorage() {
...
addStorage() {
	...
	Mark.create({ name: "strike" }).extend({ 
	/**
	* @return {{markdown: MarkdownMarkSpec}}
	*/
addStorage() {
