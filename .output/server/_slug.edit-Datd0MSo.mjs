...
import { Jt as GitBranch, Nn as Bot, P as Sparkles, Pt as History, V as Save, Vn as ArrowLeft, b as Trash2, gt as LoaderCircle, n as X } from "./_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_slug.edit-Datd0MSo.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var SKILL_VERSIONS_CONFIG = {
...
function SkillEdit() {
	...
	const coachSessionId = skillId && user ? deterministicSessionId(currentWorkspace ?? "personal", user.id, skillId) : "draft";
	(0, import_react.useEffect)(() => {
		if (!authLoading && !user) navigate(`/auth?redirect=/skills/${slug}/edit`, { replace: true });
	}, [
		user,
		authLoading,
		navigate,
	...
	const handleSuggestMetadata = async () => {
		...
		try {
			const { data: result, error } = await supabase.functions.invoke("suggest-skill-metadata", { body: {
				skill_content: formData.content.trim(),
				user_id: user?.id
			} });
	...
	const handleSaveAsNewVersion = async () => {
		...
		try {
			const { data: latest } = await supabase.from("skill_versions").select("version_number").eq("skill_id", skillId).order("version_number", { ascending: false }).limit(1).maybeSingle();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link$1, {
							...
							children: [
								...
								isMobile && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sheet, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTrigger, {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetHeader, {
											className: "sr-only",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTitle, { children: "Skill Coach" })
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogTitle, { children: "Delete this skill?" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogDescription, {
									asChild: true,
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "space-y-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "This action cannot be undone. Deleting this skill will also remove:" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
												htmlFor: "visibility",
												className: "text-base",
												children: "Make this skill public"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-sm text-muted-foreground",
												children: formData.isPublic ? "Anyone can discover and use this skill" : "Only you can see this skill"
			...
			skillId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VersionHistoryPanel, {
