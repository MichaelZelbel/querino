...
import { Nn as Bot, P as Sparkles, V as Save, Vn as ArrowLeft, gt as LoaderCircle, n as X } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/new-CAQsQ7Sj.js
...
function SkillNew() {
	...
	(0, import_react.useEffect)(() => {
		if (!authLoading && !user) navigate("/auth?redirect=/skills/new", { replace: true });
	}, [
		user,
		authLoading,
		navigate
	...
	const handleSuggestMetadata = async () => {
		...
		try {
			const { data, error } = await supabase.functions.invoke("suggest-skill-metadata", { body: {
	...
	const handleSubmit = async () => {
		...
		try {
			...
			if (newSkill?.id) promoteDraftSession(workspaceScope, user.id, newSkill.id, "skill");
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link$1, {
							...
							children: [isMobile && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sheet, {
								...
								className: "gap-2",
								children: [isSubmitting ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Save, { className: "h-4 w-4" }), "Create Skill"]
							})]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
												...
												children: isPublic ? "Anyone can discover and use this skill" : "Only you can see this skill"
