...
//#region node_modules/.nitro/vite/services/ssr/assets/PromptCoachPanel-Bs9KS7xf.js
...
function PromptCoachPanel({ artifactId, canvasContent, onApplyContent, onUndo, canUndo, isNewPrompt = false, userId, workspaceId, sessionId }) {
	...
	const [messages, setMessages] = (0, import_react.useState)(() => {
		...
		return isNewPrompt ? [{
			role: "assistant",
			content: "What do you want this prompt to do?"
		}] : [];
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: "This AI sees your current prompt content."
			}),
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						messages.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { className: "h-10 w-10 text-muted-foreground/40 mb-3" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-sm text-muted-foreground",
								children: "Ask me to improve your prompt, or use the quick actions below."
							})]
						}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: QUICK_ACTIONS.map((action) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
					variant: "outline",
